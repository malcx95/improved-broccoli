...
\lstinputlisting[matlab]{../trapezoid.m}

I Bilaga \ref{sub:testcode} listas även koden som användes för evaluering av
...
\subsection{MATLAB-kod för beräkning av fel och aritmetisk komplexitet}
\label{sub:testcode}
